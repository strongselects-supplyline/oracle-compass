...
const SHEETS = {
  ...
  HEALTH: { name: 'HEALTH', headers: ['Date', 'Weight', 'SleepHours', 'Workout', 'Mobility', 'Vocal', 'Protein', 'Steps', 'Pushups', 'Squats', 'FuelPre', 'FuelMid', 'FuelPost', 'Hydration', 'DairyFlag', 'ConditioningType', 'ConditioningMinutes', 'Score', 'Notes'] },
