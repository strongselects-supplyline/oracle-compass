...
export const PROJECTS: Project[] = [
    {
        ...
        tracks: [
            ...
            { title: 'East Side Love', bpm: 98, key: 'C# min', rbConf: 0.59, sexy: 0.87, chill: 0.63, romantic: 0.62, happy: 0.38, uplifting: 0.05, energetic: 0.10, isrc: '', status: 'unreleased', releaseDate: '2026-03-20', pitchDeadline: '2026-03-13', isLeadSingle: true, leadRank: 2 },
...
export const TIMELINE_EVENTS: TimelineEvent[] = [
    ...
    { date: '2026-03-20', label: 'East Side Love', project: 'all-love', type: 'single' },
