...
export const PROJECTS: Project[] = [
    {
        ...
        role: 'Re-establish presence, lead project', trackCount: 11, targetDate: '2026-04-17',
        tracks: [
            ...
            { title: 'East Side Love', bpm: 98, key: 'C# min', rbConf: 0.59, sexy: 0.87, chill: 0.63, romantic: 0.62, happy: 0.38, uplifting: 0.05, energetic: 0.10, isrc: '', status: 'unreleased', releaseDate: '2026-03-27', pitchDeadline: '2026-03-20', isLeadSingle: true, leadRank: 2 },
            ...
            { title: 'Sweet Frustration', bpm: 124, key: 'Bb min', rbConf: 0.25, sexy: 0.85, chill: 0.36, romantic: 0.37, happy: 0.69, uplifting: 0.58, energetic: 0.48, isrc: '', status: 'unreleased', releaseDate: '2026-04-03', pitchDeadline: '2026-03-27', isLeadSingle: true, leadRank: 3 },
            { title: 'Like I Did', bpm: 110, key: 'D min', rbConf: 0.57, sexy: 0.60, chill: 0.73, romantic: 0.63, happy: 0.69, uplifting: 0.29, energetic: 0.17, isrc: '', status: 'unreleased', releaseDate: '2026-04-10', pitchDeadline: '2026-04-03', isLeadSingle: true, leadRank: 4 },
...
export const TIMELINE_EVENTS: TimelineEvent[] = [
    ...
    { date: '2026-03-27', label: 'East Side Love', project: 'all-love', type: 'single' },
    { date: '2026-04-03', label: 'Sweet Frustration', project: 'all-love', type: 'single' },
    { date: '2026-04-10', label: 'Like I Did', project: 'all-love', type: 'single' },
    { date: '2026-04-17', label: 'ALL LOVE', project: 'all-love', type: 'album' },
