...
export const SPRINT_WEEKS: SprintWeek[] = [
  ...
  },
  {
    ...
    keyEvents: ['ALL LOVE topline recording through Wed night', 'ESL upload to Amuse by Mar 30', 'DoorDash bridge: $1,000 target by Apr 3'],
  },
  {
    ...
    keyEvents: ['ESL Amuse upload deadline Mar 30', 'SF mix/master close target Apr 1', 'LID mix/master close target Apr 1', 'East Side Love drops Apr 3 \uD83D\uDD25', '$1,000 DD bill due Apr 3', 'DoorDash bridge ends'],
  },
  {
    ...
    keyEvents: ['SF Amuse upload deadline Apr 6', 'Sweet Frustration drops Apr 10 \uD83D\uDD25', 'LID Amuse upload deadline Apr 13', '$50 ad push \u2014 Denver, Minneapolis, Dallas, Calgary'],
  },
  {
    ...
    keyEvents: ['LID Amuse upload deadline Apr 13', 'EP Amuse upload deadline Apr 14', '414 Day performance Apr 14 \uD83C\uDFA4 (GF filming)', 'QR code at venue \u2192 Spotify pre-save', 'Like I Did drops Apr 17 \uD83D\uDD25', 'All CTAs shift to "pre-save ALL LOVE EP"'],
  },
  {
