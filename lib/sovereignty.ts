...
export const RANKS: RankDef[] = [
  ...
  },
  {
    ...
    sobrietyDay: 60,
    benchmarks: [
      'ALL LOVE EP Released — Jun 20 waterfall complete',
      '3 waterfall singles Live on Spotify — ESL, GL, SF',
