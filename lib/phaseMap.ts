...
export const PHASE_MAP: Record<string, PhaseDay> = {
  ...
  "2026-04-30": { arc: "1", phase: "Recording Marathon", weekName: "Wk 2 — Record + Mix + Master", dayLabel: "RECORD DAY 2", badge: "Record", badgeClass: "badge-blue", cardClass: "card-left blue", deliverable: "Record WU2 + ESL (correct file). Push through.", sub: "Batch mode.", nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-05-15" },
  ...
  "2026-05-02": { arc: "1", phase: "Recording Marathon", weekName: "Wk 2 — Record + Mix + Master", dayLabel: "MIX DAY 1", badge: "Mix", badgeClass: "badge-blue", cardClass: "card-left blue", deliverable: "Mix ESL (correct master) + GL. 9-stage protocol.", sub: "Batch mode.", nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-05-15" },
  "2026-05-03": { arc: "1", phase: "Recording Marathon", weekName: "Wk 2 — Record + Mix + Master", dayLabel: "MIX DAY 2", badge: "Mix", badgeClass: "badge-blue", cardClass: "card-left blue", deliverable: "Mix SF + WU2. Sunday — push through.", sub: "Batch mode.", nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-05-15" },
  "2026-05-04": { arc: "1", phase: "Recording Marathon", weekName: "Wk 2 — Record + Mix + Master", dayLabel: "MASTER DAY", badge: "Master", badgeClass: "badge-green", cardClass: "card-left green", deliverable: "Master all 4 tracks (1 hr each). ESL + GL + SF + WU2.", sub: "Batch mode.", nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-05-15" },
  "2026-05-05": { arc: "1", phase: "Recording Marathon", weekName: "Wk 2 — Record + Mix + Master", dayLabel: "QC + COVER ART", badge: "Master", badgeClass: "badge-green", cardClass: "card-left green", deliverable: "Final QC listens (phone/car). Lock EP cover art.", sub: "Batch mode.", nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-05-15" },
  ...
  "2026-05-08": { arc: "1", phase: "EP Campaign — Pre-Release", weekName: "Wk 3 — EP Upload", dayLabel: "EDITORIAL PITCH", badge: "Pitch", badgeClass: "badge-blue", cardClass: "card-left blue", deliverable: "Spotify for Artists: EP editorial pitch. Feature WU2 as exclusive.", sub: "Pitch 7 days before release.", nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-05-15" },
  "2026-05-09": { arc: "1", phase: "EP Campaign — Pre-Release", weekName: "Wk 3 — EP Upload", dayLabel: "CONTENT PREP", badge: "Content", badgeClass: "badge-gold", cardClass: "card-left", deliverable: "Write 5 captions (one per track). Schedule pre-save push. Build 50-person DM list.", sub: "Saturday prep.", nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-05-15" },
  "2026-05-10": { arc: "1", phase: "EP Campaign — Pre-Release", weekName: "Wk 3 — EP Upload", dayLabel: "PRE-SAVE PUSH", badge: "Content", badgeClass: "badge-gold", cardClass: "card-left", deliverable: "Post #1: EP teaser (all 5 track names). IG Story with pre-save link.", sub: "Sunday.", nn: FLATLINE_NN, dropLabel: "Days to EP", dropDate: "2026-05-15" },
  "2026-05-11": { arc: "1", phase: "EP Campaign — Pre-Release", weekName: "Wk 3 — EP Upload", dayLabel: "SUNDAY", badge: "Sunday", badgeClass: "badge-purple", cardClass: "card-left purple", deliverable: "Grief journal. DM list finalize. Check Amuse ingestion status.", sub: "Sunday.", nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-05-15" },
