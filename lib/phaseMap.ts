...
export const PHASE_MAP: Record<string, PhaseDay> = {
  ...
  // ═══ PHASE 1b: EP UPLOAD + PRE-RELEASE (May 9 – May 14) ═══
  "2026-05-07": { arc: "1", phase: "Sprint — EP Production", weekName: "Wk 3 — Final Production", dayLabel: "STUDIO — FINISH TRACKS", badge: "Produce", badgeClass: "badge-blue", cardClass: "card-left blue", deliverable: "GL / SF / WU2 — mix and master. Lock what you can.", sub: "Wednesday. 4 days to upload.", nn: ARC1_NN, dropLabel: "Days to Upload", dropDate: "2026-05-11" },
  "2026-05-08": { arc: "1", phase: "Sprint — EP Production", weekName: "Wk 3 — Final Production", dayLabel: "STUDIO — FINISH TRACKS", badge: "Produce", badgeClass: "badge-blue", cardClass: "card-left blue", deliverable: "GL / SF / WU2 — continue mixing. Lock masters.", sub: "Thursday. 3 days to upload.", nn: ARC1_NN, dropLabel: "Days to Upload", dropDate: "2026-05-11" },
  "2026-05-09": { arc: "1", phase: "EP Campaign — Pre-Release", weekName: "Wk 3 — ESL Live", dayLabel: "ESL DROPS", badge: "Release", badgeClass: "badge-red", cardClass: "card-left red", deliverable: "East Side Love advance single live. Release Radar trigger #1. Let it breathe — don't mention EP today.", sub: "ESL-only content day. Follow CTA on every post.", warning: { type: "important", icon: "🎵", text: "<strong>ESL IS LIVE.</strong> Let it breathe 48 hrs before announcing EP. Every post ends with Follow on Spotify CTA." }, nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-05-15" },
  "2026-05-10": { arc: "1", phase: "EP Campaign — Pre-Release", weekName: "Wk 3 — ESL Live + Final Production", dayLabel: "ESL BREATHE + STUDIO", badge: "Produce", badgeClass: "badge-blue", cardClass: "card-left blue", deliverable: "ESL content sustain. Lock remaining masters. Saturday.", sub: "ESL 24-hr data check. Keep producing — upload is tomorrow night.", nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-05-15" },
  "2026-05-11": { arc: "1", phase: "EP Campaign — Pre-Release", weekName: "Wk 3 — EP Upload", dayLabel: "EP AMUSE UPLOAD", badge: "Upload", badgeClass: "badge-green", cardClass: "card-left green", deliverable: "Upload all 5 tracks + EP entity to Amuse tonight. Genre: R&B / Alt-R&B. Set release May 15.", sub: "Sunday night. Screenshot ISRC page.", warning: { type: "important", icon: "📋", text: "<strong>ISRC CARRY:</strong> Enter SEE ME's ISRC from Mar 13 onto EP track 3. Enter ESL's ISRC from Apr 30 onto EP track 4. GL/SF/WU2 get new ISRCs." }, nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-05-15" },
  "2026-05-12": { arc: "1", phase: "EP Campaign — Pre-Release", weekName: "Wk 3 — EP Countdown", dayLabel: "EP ANNOUNCE + PITCH", badge: "Content", badgeClass: "badge-gold", cardClass: "card-left", deliverable: "Tracklist reveal. Spotify for Artists: pitch Sweet Frustration as EP focus track. Use ESL reception as proof.", sub: "Monday. T-3 to EP. KAYTRANADA lane — pitch that angle. Build DM list from ESL engagers.", nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-05-15" },
  "2026-05-13": { arc: "1", phase: "EP Campaign — Pre-Release", weekName: "Wk 3 — EP Countdown", dayLabel: "WU2 SNIPPET + WORLD BUILD", badge: "Content", badgeClass: "badge-gold", cardClass: "card-left", deliverable: "Post: WU2 snippet/teaser ('Only on the EP') + world-building visual. DM blitz prep.", sub: "Tuesday. T-2. Hook for EP-exclusive content.", nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-05-15" },
  "2026-05-14": { arc: "1", phase: "EP Campaign — Pre-Release", weekName: "Wk 3 — EP Countdown", dayLabel: "EVE OF EP", badge: "Eve", badgeClass: "badge-orange", cardClass: "card-left orange", deliverable: "Talk to 'Em: what ALL LOVE means. Final DM blitz. Ads staged. Check Amuse ingestion status.", sub: "Wednesday. Tomorrow it drops.", nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-05-15" },
  ...
  // 2026-07-10 = CREAM DECISION (see below — overrides JSS eve-of-release on this date)
  ...
  // 2026-07-17 = 90-DAY REVIEW (see below — overrides JSS compliance day on this date)
