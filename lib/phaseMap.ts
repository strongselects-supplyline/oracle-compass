...
export const PHASE_MAP: Record<string, PhaseDay> = {
  ...
  "2026-05-19": { arc: "1", phase: "EP Campaign — Pre-Release", weekName: "Wk 4 — EP Upload", dayLabel: "EP AMUSE UPLOAD", badge: "Upload", badgeClass: "badge-green", cardClass: "card-left green", deliverable: "Upload ALL LOVE (EP) to Amuse. Set release May 29.", sub: "Tuesday night. Screenshot ISRC page.", warning: { type: "important", icon: "📋", text: "<strong>ISRC CARRY:</strong> Enter SEE ME's ISRC from Mar 13 onto EP track 1. Enter ESL's ISRC from May 8 onto EP track 4." }, nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-05-29" },
