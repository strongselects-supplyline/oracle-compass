...
export const PHASE_MAP: Record<string, PhaseDay> = {
  ...
  "2026-04-18": { arc: "1", phase: "Honeymoon", weekName: "Wk 1 — Ship the EP", dayLabel: "COMP DAY", badge: "Comp", badgeClass: "badge-gold", cardClass: "card-left", deliverable: "Comp all 4 tracks · ESL → SF → WU2 → RV", sub: "9:30 AM – 6 PM · 2 hrs/track + 30 min tuning buffer · Reference SEE ME", nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-04-25" },
  "2026-04-19": { arc: "1", phase: "Honeymoon", weekName: "Wk 1 — Ship the EP", dayLabel: "MIX DAY", badge: "Mix", badgeClass: "badge-blue", cardClass: "card-left blue", deliverable: "Mix all 4 tracks · 9-stage Sovereign Protocol", sub: "10 AM – 1 AM · 3 hrs/track · QC pass + phone/car listen", nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-04-25" },
  "2026-04-20": { arc: "1", phase: "Honeymoon", weekName: "Wk 1 — Ship the EP", dayLabel: "MASTER + UPLOAD", badge: "Upload", badgeClass: "badge-green", cardClass: "card-left green", deliverable: "Master 4 tracks · Upload to Amuse 8–10 PM", sub: "Ozone 12 · 24/44.1/-1 dBFS · Screenshot confirmation + ISRC page", warning: { type: "important", icon: "📋", text: "Open <strong>AMUSE_UPLOAD_CHECKLIST_APR20.md</strong>. Top to bottom. Screenshot every gate." }, nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-04-25" },
  "2026-04-21": { arc: "1", phase: "Honeymoon", weekName: "Wk 1 — Ship the EP", dayLabel: "COMPLIANCE + CONTENT BATCH", badge: "Batch", badgeClass: "badge-gold", cardClass: "card-left", deliverable: "ASCAP/BMI register all 4 + SEE ME · Batch-film 7 posts", sub: "7 AM: Amuse rejection check · One filming session, edit all week", nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-04-25" },
  "2026-04-22": { arc: "1", phase: "Honeymoon", weekName: "Wk 1 — Ship the EP", dayLabel: "EDITORIAL PITCHES", badge: "Pitch", badgeClass: "badge-gold", cardClass: "card-left", deliverable: "Spotify for Artists pitches (backup) · Edit + schedule Posts 1–3", sub: "Draft WU2 + RV pitches · Denver-heavy geo context", nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-04-25" },
  "2026-04-23": { arc: "1", phase: "Honeymoon", weekName: "Wk 1 — Ship the EP", dayLabel: "CURATOR OUTREACH", badge: "Outreach", badgeClass: "badge-gold", cardClass: "card-left", deliverable: "Send 40 curator emails · Finalize 50-DM list for release day", sub: "Top 20 playlists × 4 tracks · Dedupe · Tier 1 first", nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-04-25" },
  "2026-04-24": { arc: "1", phase: "Honeymoon", weekName: "Wk 1 — Ship the EP", dayLabel: "RELEASE EVE", badge: "Eve", badgeClass: "badge-orange", cardClass: "card-left orange", deliverable: "Auto-Save link live · Pre-save URL captured · Apr 25 release confirmed", sub: "Protocol check-in · Honeymoon closes tonight", warning: { type: "warning", icon: "⚠️", text: "Tomorrow: write \"Post 7 AM. Send 50 DMs by 9 AM.\" on paper. <strong>Flatline begins Sun Apr 26.</strong>" }, nn: ARC1_NN, dropLabel: "Days to EP", dropDate: "2026-04-25" },

  // ═══ ARC 1 — WEEK 2: EP LIVE + FLATLINE BEGINS ═══
  "2026-04-25": { arc: "1", phase: "Flatline Day 0", weekName: "Wk 2 — EP Live", dayLabel: "EP DROPS", badge: "Release", badgeClass: "badge-red", cardClass: "card-left red", deliverable: "50 personal DMs · Spotify Ad Studio $50 launches · Release-day post", sub: "6:30 AM: confirm live on all DSPs · Denver $20 / MPLS $15 / DAL $15", warning: { type: "important", icon: "🎉", text: "Uranus enters Gemini. Don't scroll stats tonight. Partner time. Check tomorrow AM." }, nn: ["50 DMs sent by 9 AM", "Spotify Ads $50 live", "Do NOT scroll stats after 8 PM"], dropLabel: "Days since EP", dropDate: "2026-04-25" },
