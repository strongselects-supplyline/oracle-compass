...
export const PHASE_MAP: Record<string, PhaseDay> = {
  ...
  "2026-04-24": { arc: "1", phase: "EP Release Day", weekName: "Wk 1 — Ship the EP", dayLabel: "EP DROPS", badge: "Release", badgeClass: "badge-red", cardClass: "card-left red", deliverable: "50 personal DMs · Spotify Ad Studio $50 launches · Release-day post", sub: "6:30 AM: confirm live on all DSPs · Denver $20 / MPLS $15 / DAL $15", warning: { type: "important", icon: "🎉", text: "Uranus enters Gemini. EP is live. Don't scroll stats tonight. Partner time. Check tomorrow AM." }, nn: ["50 DMs sent by 9 AM", "Spotify Ads $50 live", "Do NOT scroll stats after 8 PM"], dropLabel: "Days to EP", dropDate: "2026-04-24" },

  // ═══ ARC 1 — WEEK 2: EP LIVE + FLATLINE BEGINS ═══
  "2026-04-25": { arc: "1", phase: "Flatline Day 0", weekName: "Wk 2 — EP Live", dayLabel: "FLATLINE DAY 0", badge: "Flatline", badgeClass: "badge-red", cardClass: "card-left red", deliverable: "First full day post-release · S4A data screenshot AM · One content piece max", sub: "Numbers, not feelings. Check S4A once. Close it.", warning: { type: "warning", icon: "⚠️", text: "<strong>Motivation will lie to you.</strong> The drop is neurochemical, not personal. Structural, not motivational. Show up to calisthenics + meditation even if pointless." }, nn: FLATLINE_NN, dropLabel: "Days since EP", dropDate: "2026-04-24" },
