...
- Deadlines: Code (ISRC) at Day 0 (post-release), Distro (Amuse) at Day -8 (8-day review window), PROs (ASCAP/Songtrust) at Day +1 (post-release).
...
Return JSON ONLY matching this exact structure:
{
  "escalations": [
    {
      "track": "Track Title",
      "issue": "Not uploaded to Amuse and currently < 3 days to release.",
      "severity": "RED"
    }
  ],
  "clear": true
